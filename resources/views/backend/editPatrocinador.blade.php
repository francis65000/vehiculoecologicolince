...
@section('content')
    ...
    <h1 class="p-4">Editar patrocinador</h1>
    <div class="card mx-3">
        <div class="card-header d-flex align-items-center justify-content-between">

        </div>
        <div class="card-body">
            <form action="{{ url('actualizar-patrocinador/'.$patrocinador->id) }}" method="POST">
                @csrf
                <!-- Menú 1 //////////////////////////////////////////////////////////////////////////////////////////-->
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <input type="text" name="nombre_patrocinador" id="nombre_patrocinador" class="form-control" value="{{$patrocinador->nombre_patrocinador}}" required>
                        </div>
                    </div>                  
                </div>
                ...
                <div class="form-group p-4">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('/entradas-patrocinadores') }}" class="btn btn-danger"><i
