...
@section('title', 'Nueva Patrocinador')

@section('content')
    <!--Mostrando la tabla con las entradas que hay-->
    <h1 class="p-4">Añadir nuevo patrocinador</h1>
    <div class="card mx-3">
        <div class="card-header d-flex align-items-center justify-content-between">

        </div>
        <div class="card-body">
            <form action="{{ url('insertar-patrocinador') }}" method="POST">
                @csrf
                <!-- Menú 1 //////////////////////////////////////////////////////////////////////////////////////////-->
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <input type="text" name="nombre_patrocinador" id="nombre_patrocinador" class="form-control" required>
                        </div>
                    </div>                  
                </div>
