...
@section('content')
    ...
    <h1 class="p-4">Editando vehículo {{}}</h1>
    <div class="card mx-3">
            ...
            <form action="{{ url('insertar-entrada') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="distanciaEntreEjes">Distancia entre ejes:</label>
                            <input type="text" name="distanciaEntreEjes" id="distanciaEntreEjes" class="form-control" maxlength="100" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
